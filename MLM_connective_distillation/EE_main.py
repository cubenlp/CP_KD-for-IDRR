...
# util.set_random_seed(54148319)
# util.set_random_seed(83195414)

# util.set_random_seed(95049803)
...
def gen_args():
    ...
    parser.add_argument("--template_version", type=int, default=111, help="dataset type")



    # 下面参数基本默认
    parser.add_argument("--data_type", type=str, default="pdtb2_top", help="dataset type")
    parser.add_argument("--version", type=str, default="deberta_masked_model", help="dataset type")
    ...
    parser.add_argument("--ckpt_save_path", type=str,
                        default="{}/grid_search/".format(WORKING_DIR), help="ckpt_save_path")
    ...
    parser.add_argument("--teacher_checkpoint_path",type=str,
                        default="/home/hongyi/discourse/prompt_distillation_template2/mlm_test_all_weights/basepdtb2_top_roberta_masked_model_epoch=1_val_acc=58.22_val_f1=34.18.ckpt",help="pretrained_teacher_model")
    ...
    '''for ipynb'''
    parser.add_argument("--ip", type=str, default='127.0.0.1', help="random seed")
    parser.add_argument("--stdin", type=int, default=9003, help="random seed")
    parser.add_argument("--control", type=int, default=9001, help="random seed")
    parser.add_argument("--hb", type=int, default=9000, help="random seed")
    parser.add_argument("--Session.signature_scheme", type=str, default="hmac-sha256", help="random seed")
    parser.add_argument("--Session.key", type=str, default="hmac-sha256", help="random seed")
    parser.add_argument("--shell", type=int, default=9000, help="random seed")
    parser.add_argument("--transport", type=str, default="hmac-sha256", help="random seed")
    parser.add_argument("--iopub", type=int, default=9000, help="random seed")
    parser.add_argument("--f", type=str, default="hmac-sha256", help="random seed")
...
def train(args):
    ...
    es = EarlyStopping('val_acc', patience=5, mode="max")


    if args.data_type.endswith("second"):
